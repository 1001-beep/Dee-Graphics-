...
export default function HomePage() {
  ...
  return (
    <main style={{ paddingBottom: 96 }}>
      {/* Hero with full-width animated banner background */}
      <section
        style={{
          minHeight: "88vh",
          display: "flex",
      ...
      >
        {/* Background image, slowly zooming */}
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: "url('https://images.unsplash.com/photo-1620207418302-439b387441b0?q=80&w=1600')",
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: `linear-gradient(180deg, rgba(7,7,10,0.75) 0%, rgba(7,7,10,0.85) 50%, ${C.bg} 100%)`,
            zIndex: 1,
          }}
        />
        {/* Gold accent glow */}
        ...
        >
          ...
          <h1 style={{ fontSize: "clamp(36px, 6vw, 72px)", fontWeight: 300, letterSpacing: "-0.02em", color: C.white, lineHeight: 1.15, marginBottom: 28, textShadow: "0 4px 30px rgba(0,0,0,0.6)" }}>
