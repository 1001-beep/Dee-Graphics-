...
const DELIVERY_OPTIONS = [
  { label: "Standard", note: "3–5 days" },
  { label: "Priority", note: "48 hours" },
  { label: "Rush",     note: "24 hours" },
];
...
export default function RequestPage() {
  ...
  const [state, setState] = useState({
    submitted: false, processing: false, trackingId: "", error: "",
  });
        ...
        {state.submitted ? (
          <div style={{ textAlign: "center", padding: "24px 0" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, textAlign: "left" }}>
                {[
                  ...
                  <div key={label}>
                    ...
                    <div style={{ fontSize: 13, color: label === "Price" ? C.gold : label === "Tracking ID" ? C.gold : C.white, fontFamily: label === "Tracking ID" ? "monospace" : "inherit", fontWeight: label === "Price" ? 700 : 400 }}>{value}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ ...glass, padding: 24, borderRadius: 2, border: `1px solid rgba(37,211,102,0.25)`, background: "rgba(37,211,102,0.05)", marginBottom: 24 }}>
              ...
              <a
                href={buildWhatsAppLink(state.trackingId)}
                target="_blank"
                rel="noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: 10, background: "#25D366", color: "#07070A", fontWeight: 700, fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", padding: "14px 28px", borderRadius: 2, textDecoration: "none", boxShadow: "0 8px 24px rgba(37,211,102,0.2)" }}
              >
            ...
            <button
              ...
              style={{ background: "none", border: `1px solid ${C.border}`, color: C.gray400, fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", padding: "10px 24px", cursor: "pointer", borderRadius: 2 }}
            >
              Submit Another
            </button>
          </div>
