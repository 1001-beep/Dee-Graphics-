...
const SUB_OPTIONS: Record<string, string[]> = {
  ...
  "AI Art Rendering": [
    "AI portraits",
    "Cartoon versions of photos",
    "Fantasy character artwork",
    "AI product mockups",
    "AI-generated wallpapers",
    "AI birthday portraits",
    "AI fashion concepts",
  ],
  "Social Campaign": [
    "Promotional flyers",
  ...
  "Motion Design": [
    ...
    "Intro videos",
    "Outro videos",
    "WhatsApp status animations",
    "Instagram reel graphics",
    "Text animations",
  ],
  "Print Layout": [
    "Flyers",
  ...
  const realSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await addDoc(collection(db, "designRequests"), {
        ...
        subOption: form.subOption || "Custom (Bespoke)",
        ...
        await emailjs.send(
          ...
          CLIENT_TEMPLATE_ID,
          {
            ...
            sub_option: form.subOption || "Custom (Bespoke)",
            speed: form.speed,
          ...
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            <div style={{ ...glass, padding: 24, borderRadius: 2, border: `1px solid rgba(37,211,102,0.25)`, background: "rgba(37,211,102,0.05)", marginBottom: 24 }}>
              <p style={{ color: C.gray400, fontSize: 13, marginBottom: 16, lineHeight: 1.7 }}>
                Tap below to send your full order details to us on WhatsApp — your tracking ID, service, and price will be included automatically.
              </p>
            ...
            {!isBespoke && (
              <div>
                ...
                <select style={{ ...inputStyle, appearance: "none", cursor: "pointer" }}
                  ...
                  {(SUB_OPTIONS[form.projectType] || []).map((o) => (
                    <option key={o} value={o} style={{ background: C.surface }}>{o}</option>
                  ))}
                </select>
              </div>
